    	...
    	<div class="typebox">
             ...
             <div class="style_div" id="ord_list_1">
					...
					<li class="swiper-slide"><a class="all" href="#">类型</a></li>
                        ...
                        <?php if(empty($obj['type_extend']['area']) || (($obj['type_extend']['area'] instanceof \think\Collection || $obj['type_extend']['area'] instanceof \think\Paginator ) && $obj['type_extend']['area']->isEmpty())): $_5f713e921ed23=explode(',',$obj['parent']['type_extend']['class']); if(is_array($_5f713e921ed23) || $_5f713e921ed23 instanceof \think\Collection || $_5f713e921ed23 instanceof \think\Paginator): if( count($_5f713e921ed23)==0 ) : echo "" ;else: foreach($_5f713e921ed23 as $key2=>$vo2): ?>
                        ...
                        <?php endforeach; endif; else: echo "" ;endif; else: $_5f713e921ed16=explode(',',$obj['type_extend']['class']); if(is_array($_5f713e921ed16) || $_5f713e921ed16 instanceof \think\Collection || $_5f713e921ed16 instanceof \think\Paginator): if( count($_5f713e921ed16)==0 ) : echo "" ;else: foreach($_5f713e921ed16 as $key2=>$vo2): ?>
                        <li class="swiper-slide<?php if($param['class'] == $vo2): ?> active<?php endif; ?>"><a href="<?php echo mac_url_type($obj,['area'=>$param['area'],'lang'=>$param['lang'],'year'=>$param['year'],'level'=>$param['level'],'letter'=>$param['letter'],'state'=>$param['state'],'tag'=>$param['tag'],'class'=>$vo2,'order'=>$param['order'],'by'=>$param['by'] ],'show'); ?>"><?php echo $vo2; ?></a></li>
             ...
             <div class="style_div" id="ord_list_2">
					...
					<li class="swiper-slide"><a class="all" href="#">地区</a></li>
                        ...
                        <?php if(empty($obj['type_extend']['area']) || (($obj['type_extend']['area'] instanceof \think\Collection || $obj['type_extend']['area'] instanceof \think\Paginator ) && $obj['type_extend']['area']->isEmpty())): $_5f713e921ecfa=explode(',',$obj['parent']['type_extend']['area']); if(is_array($_5f713e921ecfa) || $_5f713e921ecfa instanceof \think\Collection || $_5f713e921ecfa instanceof \think\Paginator): if( count($_5f713e921ecfa)==0 ) : echo "" ;else: foreach($_5f713e921ecfa as $key2=>$vo2): ?>
                        ...
                        <?php endforeach; endif; else: echo "" ;endif; else: $_5f713e921eced=explode(',',$obj['type_extend']['area']); if(is_array($_5f713e921eced) || $_5f713e921eced instanceof \think\Collection || $_5f713e921eced instanceof \think\Paginator): if( count($_5f713e921eced)==0 ) : echo "" ;else: foreach($_5f713e921eced as $key2=>$vo2): ?>
                        <li class="swiper-slide<?php if($param['area'] == $vo2): ?> active<?php endif; ?>"><a  href="<?php echo mac_url_type($obj,['area'=>$vo2,'lang'=>$param['lang'],'year'=>$param['year'],'level'=>$param['level'],'letter'=>$param['letter'],'state'=>$param['state'],'tag'=>$param['tag'],'class'=>$param['class'],'order'=>$param['order'],'by'=>$param['by'] ],'show'); ?>"><?php echo $vo2; ?></a></li>
                        <?php endforeach; endif; else: echo "" ;endif; endif; ?>
             ...
             <div class="style_div" id="ord_list_3">
					...
					<li class="swiper-slide"><a class="all" href="#">年代</a></li>
                        ...
                        <?php if(empty($obj['type_extend']['year']) || (($obj['type_extend']['year'] instanceof \think\Collection || $obj['type_extend']['year'] instanceof \think\Paginator ) && $obj['type_extend']['year']->isEmpty())): $_5f713e921ecd0=explode(',',$obj['parent']['type_extend']['year']); if(is_array($_5f713e921ecd0) || $_5f713e921ecd0 instanceof \think\Collection || $_5f713e921ecd0 instanceof \think\Paginator): if( count($_5f713e921ecd0)==0 ) : echo "" ;else: foreach($_5f713e921ecd0 as $key2=>$vo2): ?>
                        ...
                        <?php endforeach; endif; else: echo "" ;endif; else: $_5f713e921ecc1=explode(',',$obj['type_extend']['year']); if(is_array($_5f713e921ecc1) || $_5f713e921ecc1 instanceof \think\Collection || $_5f713e921ecc1 instanceof \think\Paginator): if( count($_5f713e921ecc1)==0 ) : echo "" ;else: foreach($_5f713e921ecc1 as $key2=>$vo2): ?>
                        <li class="swiper-slide<?php if($param['year'] == $vo2): ?> active<?php endif; ?>"><a href="<?php echo mac_url_type($obj,['area'=>$param['area'],'lang'=>$param['lang'],'year'=>$vo2,'level'=>$param['level'],'letter'=>$param['letter'],'state'=>$param['state'],'tag'=>$param['tag'],'class'=>$param['class'],'order'=>$param['order'],'by'=>$param['by'] ],'show'); ?>"><?php echo $vo2; ?></a></li>
                        <?php endforeach; endif; else: echo "" ;endif; endif; ?>
                   </ul>
             </div>
