<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"D:\phpstudy_pro\WWW\applecms\applecms/application/admin\view\urlsend\index.html";i:1579008638;s:77:"D:\phpstudy_pro\WWW\applecms\applecms\application\admin\view\public\head.html";i:1579008638;s:77:"D:\phpstudy_pro\WWW\applecms\applecms\application\admin\view\public\foot.html";i:1579008638;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <form class="layui-form layui-form-pane" method="post" action="" id="form1">
            <div class="layui-form-item">
                ...
                <fieldset class="layui-elem-field layui-field-title layui-input-inline" style="margin-top: 30px; width:33%; padding: 5px;">
                    ...
                    <hr class="layui-bg-gray">
                    <input type="button" value="当天网址导航" class="layui-btn layui-btn-primary" onclick="post('ac=baidu_push&ac2=today&mid=11');">
                    <input type="button" value="全部网址导航" class="layui-btn layui-btn-primary" onclick="post('ac=baidu_push&ac2=all&mid=11');">
                    <hr class="layui-bg-gray">
                ...
                <fieldset class="layui-elem-field layui-field-title layui-input-inline" style="margin-top: 30px; width:33%; padding: 5px;">
                    ...
                    <hr class="layui-bg-gray">
                    <input type="button" value="当天网址导航" class="layui-btn layui-btn-primary" onclick="post('ac=baidu_bear&ac2=today&type=realtime&mid=11');">
                    <input type="button" value="全部网址导航" class="layui-btn layui-btn-primary" onclick="post('ac=baidu_bear&ac2=all&type=batch&mid=11');">
                    <hr class="layui-bg-gray">
